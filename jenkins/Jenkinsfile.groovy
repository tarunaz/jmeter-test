node('maven-fortify') {
   ...
   performanceReport compareBuildPrevious: false,
        ...
        modeThroughput: true,
        nthBuildNumber: 0,
        parsers: [[$class: 'JMeterParser', glob: '/tmp/workspace/tarun-jmeter-pipeline/HTTP Request.jtl']],
   ...
   // Running Performance Plugin with JMeter to show results
    performanceReport compareBuildPrevious: false,
        ...
        modeThroughput: true,
        nthBuildNumber: 0,
        parsers: [[$class: 'JMeterParser', glob: '/tmp/workspace/tarun-jmeter-pipeline/20171203-HTTP Request.jtl']],
        relativeFailedThresholdNegative: 0,
        relativeFailedThresholdPositive: 0,
        relativeUnstableThresholdNegative: 0,
        relativeUnstableThresholdPositive: 0
